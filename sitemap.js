         ...
         // get the post labels from the entry
            ...
            if ("category" in entry) {
               for (var k = 0; k < entry.category.length; k++) {
                  pll += '<a href="javascript:filterPosts(\'' + entry.category[k].term + '\');" title="انقر هنا لتحديد كافة المشاركات ذات التصنيف\'' + entry.category[k].term + '\'">' + entry.category[k].term + '</a>,  ';
               }
...
// this function creates a three-column table and adds it to the screen
   ...
   var tocTool1 = 'انقر للفرز حسب العنوان';
   var tocHead2 = 'تاريخ النشر';
   var tocTool2 = 'انقر للفرز حسب التاريخ';
   var tocHead3 = 'تسميات';
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (تنازلي)';
